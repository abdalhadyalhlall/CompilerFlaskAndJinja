// Generated from C:/D/compilertest/CompilerFlaskAndJinja/src/antlrJinja/HTMLCSSJINJA_lexer.g4 by ANTLR 4.13.2
package antlrJinja;
...
public class HTMLCSSJINJA_lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"CSS_FONT_VALUE", "CSS_GENERIC_VALUE", "INT", "FLOAT", "LENGTH_UNIT", 
			"LENGTH", "LENGTH_POSITION", "PERCENT", "HASH_COLOR", "RGB_FUNC", "RGBA_FUNC", 
			"HSL_FUNC", "HSLA_FUNC", "URL_FUNC", "NAMED_COLOR", "FONT_SIZE_VALUE", 
			"FONT_WEIGHT_VALUE", "FONT_STYLE_VALUE", "FONT_FAMILY_VALUE", "OPACITY_VALUE", 
			"CURSOR_VALUE", "FILTER_VALUE", "FILTER_FUNC", "BLEND_MODE_VALUE", "NAME", 
			"STYLE_WS", "JINJA_EXPR_END", "JINJA_EXPR_WS", "JINJA_EXPR_STRING", "JINJA_EXPR_ATOM", 
			"JINJA_EXPR_SYMBOL", "JINJA_EXPR_UNKNOWN", "JINJA_STMT_END", "JINJA_STMT_IF", 
			...
			"JINJA_STMT_WS", "JINJA_STMT_STRING", "JINJA_STMT_ATOM", "JINJA_STMT_SYMBOL", 
			"JINJA_STMT_UNKNOWN"
		};
	}
