// Generated from C:/Users/User/Desktop/المشاريع/CompilerFlaskAndJinja/src/antlrJinja/HTMLCSSJINJA_lexer.g4 by ANTLR 4.13.2
package antlrJinja;
...
public class HTMLCSSJINJA_lexer extends Lexer {
	...
	public static final int
		TAG_MODE=1, STYLE_MODE=2, JINJA_EXPR_MODE=3, JINJA_STMT_MODE=4;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "TAG_MODE", "STYLE_MODE", "JINJA_EXPR_MODE", "JINJA_STMT_MODE"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "JINJA_EXPR_START", "JINJA_STMT_START", "END_TAG_START", "OPEN_TAG_START", 
			"HTML_COMMENT", "JANJI_COMMENT", "TEXT", "EQUALS", "STYLE_ATTRIBUTE_START", 
			"TAG_DOCTYPE", "TAG_HTML", "TAG_HEAD", "TAG_META", "TAG_TITLE", "TAG_BODY", 
			"TAG_DIV", "TAG_H1", "TAG_H2", "TAG_H3", "TAG_H4", "TAG_H5", "TAG_H6", 
			"TAG_P", "TAG_A", "TAG_IMG", "TAG_BR", "TAG_HR", "TAG_INPUT", "TAG_FORM", 
			"TAG_LABEL", "TAG_BUTTON", "TAG_STRONG", "TAG_B", "TAG_I", "TAG_EM", 
			"TAG_U", "TAG_SMALL", "TAG_MARK", "TAG_SUB", "TAG_SUP", "TAG_BLOCKQUOTE", 
			"TAG_CODE", "TAG_PRE", "TAG_SELECT", "TAG_OPTION", "TAG_TEXTAREA", "TAG_DATALIST", 
			"TAG_FIELDSET", "TAG_LEGEND", "TAG_OPTGROUP", "TAG_AUDIO", "TAG_VIDEO", 
			"TAG_CANVAS", "TAG_SVG", "TAG_PICTURE", "TAG_UL", "TAG_OL", "TAG_LI", 
			"TAG_DL", "TAG_DT", "TAG_DD", "TAG_TABLE", "TAG_THEAD", "TAG_TBODY", 
			"TAG_TFOOT", "TAG_TR", "TAG_TD", "TAG_TH", "TAG_CAPTION", "TAG_COLGROUP", 
			"TAG_FIGURE", "TAG_FIGCAPTION", "TAG_DETAILS", "TAG_SUMMARY", "TAG_DIALOG", 
			"TAG_LINK", "TAG_SOURCE", "TAG_TRACK", "TAG_WBR", "TAG_AREA", "TAG_BASE", 
			"TAG_COL", "TAG_EMBED", "TAG_PARAM", "TAG_SECTION", "TAG_ARTICLE", "TAG_NAV", 
			"TAG_ASIDE", "TAG_HEADER", "TAG_FOOTER", "TAG_MAIN", "TAG_SPAN", "ATTR_HIDDEN", 
			"ATTR_DRAGGABLE", "ATTR_CONTENTEDITABLE", "ATTR_TRANSLATE", "ATTR_REQUIRED", 
			"ATTR_READONLY", "ATTR_DISABLED", "ATTR_CHECKED", "ATTR_MULTIPLE", "ATTR_NOVALIDATE", 
			"ATTR_CONTROLS", "ATTR_AUTOPLAY", "ATTR_LOOP", "ATTR_MUTED", "ATTR_ID", 
			"ATTR_CLASS", "ATTR_TITLE", "ATTR_LANG", "ATTR_DIR", "ATTR_TABINDEX", 
			...
			"CSS_GENERIC_VALUE", "INT", "FLOAT", "LENGTH_UNIT", "LENGTH", "LENGTH_POSITION", 
			"PERCENT", "HASH_COLOR", "RGB_FUNC", "RGBA_FUNC", "HSL_FUNC", "HSLA_FUNC", 
			"URL_FUNC", "NAMED_COLOR", "FONT_SIZE_VALUE", "FONT_WEIGHT_VALUE", "FONT_STYLE_VALUE", 
			"FONT_FAMILY_VALUE", "OPACITY_VALUE", "CURSOR_VALUE", "FILTER_VALUE", 
			"FILTER_FUNC", "BLEND_MODE_VALUE", "NAME", "JINJA_EXPR_END", "JINJA_EXPR_STRING", 
			"JINJA_EXPR_ATOM", "JINJA_EXPR_SYMBOL", "JINJA_STMT_END", "JINJA_STMT_IF", 
			"JINJA_STMT_ENDIF", "JINJA_STMT_FOR", "JINJA_STMT_ENDFOR", "JINJA_STMT_ELSE", 
			"JINJA_STMT_ELIF", "JINJA_STMT_IN", "JINJA_STMT_SET", "JINJA_STMT_BLOCK", 
			"JINJA_STMT_ENDBLOCK", "JINJA_STMT_WITH", "JINJA_STMT_ENDWITH", "JINJA_STMT_MACRO", 
			"JINJA_STMT_ENDMACRO", "JINJA_STMT_INCLUDE", "JINJA_STMT_EXTENDS", "JINJA_STMT_FROM", 
			"JINJA_STMT_STRING", "JINJA_STMT_ATOM", "JINJA_STMT_SYMBOL"
		};
	}
	...
	public HTMLCSSJINJA_lexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "HTMLCSSJINJA_lexer.g4"; }
