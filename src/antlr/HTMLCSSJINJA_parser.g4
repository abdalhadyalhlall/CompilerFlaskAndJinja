...
length: CSS_LENGTH_PROPERTY CSS_TWOPOINT CSS_SHORTHAND_VALUE+ CSS_SEMI;
...
position: CSS_POSITION_PROPERTY CSS_TWOPOINT CSS_SHORTHAND_VALUE+ CSS_SEMI;

offset: CSS_OFFSET_PROPERTY CSS_TWOPOINT CSS_SHORTHAND_VALUE CSS_SEMI;

border_style: CSS_BORDER_STYLE_PROPERTY CSS_TWOPOINT CSS_BORDER_STYLE_VALUE CSS_SEMI;

border_width: CSS_BORDER_WIDTH_PROPERTY CSS_TWOPOINT (CSS_BORDER_WIDTH_VALUE | CSS_SHORTHAND_VALUE) CSS_SEMI;

border: CSS_BORDER_PROPERTY CSS_TWOPOINT (CSS_SHORTHAND_VALUE | CSS_COLOR_VALUE)+ CSS_SEMI;

font: CSS_FONT_PROPERTY CSS_TWOPOINT (CSS_FONT_VALUE | CSS_SHORTHAND_VALUE) CSS_SEMI;

textcss: CSS_TEXT_PROPERTY CSS_TWOPOINT (CSS_TEXT_VALUE | CSS_SHORTHAND_VALUE) CSS_SEMI;

effect: CSS_EFFECT_PROPERTY CSS_TWOPOINT (CSS_EFFECT_VALUE | CSS_SHORTHAND_VALUE)+ CSS_SEMI;

layout: CSS_LAYOUT_PROPERTY CSS_TWOPOINT CSS_LAYOUT_VALUE+ CSS_SEMI;
...
jinjaStmtArgument
    : JINJA_STMT_ATOM   | JINJA_STMT_SYMBOL   | JINJA_STMT_STRING   | JINJA_STMT_UNKNOWN
    | JINJA_STMT_ELSE | JINJA_STMT_ELIF | JINJA_STMT_IN | JINJA_STMT_SET
    | JINJA_STMT_BLOCK | JINJA_STMT_ENDBLOCK | JINJA_STMT_WITH | JINJA_STMT_ENDWITH
    | JINJA_STMT_MACRO | JINJA_STMT_ENDMACRO | JINJA_STMT_INCLUDE
    | JINJA_STMT_EXTENDS | JINJA_STMT_FROM
    ;
